    ...
    <div>
        ...
        <Table  striped bordered hover size="sm">
            ...
            <tbody>
                ...
                <td className="buttons-holder">{ 
                        applicationStatus[i+4] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+4])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+5]}</td>
                ...
                <td className="buttons-holder">{ 
                        applicationStatus[i+5] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+5])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+6]}</td>
                ...
                <td className="buttons-holder">{ 
                        applicationStatus[i+6] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+6])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+7]}</td>
                ...
                <td className="buttons-holder">{ 
                        applicationStatus[i+7] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+7])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+8]}</td>
                <td>{applicationDate[i+8]}</td>
                <td>{applicationType[i+8]}</td>
                <td>{applicationStatus[i+8]}</td>
                <td className="buttons-holder">{ 
                        applicationStatus[i+7] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+8])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+7]}</td>
                <td>{applicationDate[i+9]}</td>
                <td>{applicationType[i+9]}</td>
                <td>{applicationStatus[i+9]}</td>
                <td className="buttons-holder">{ 
                        applicationStatus[i+9] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+9])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+10]}</td>
                <td>{applicationDate[i+10]}</td>
                <td>{applicationType[i+10]}</td>
                <td>{applicationStatus[i+10]}</td>
                <td className="buttons-holder">{ 
                        applicationStatus[i+10] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+10])}}>Προβολή</Button>
                </td>
                </tr>
                <tr>
                <td>{index[i+11]}</td>
                <td>{applicationDate[i+11]}</td>
                <td>{applicationType[i+11]}</td>
                <td>{applicationStatus[i+11]}</td>
                <td className="buttons-holder">{ 
                        applicationStatus[i+11] === "Αποθηκευμένη" &&
                        (<Button className="but-table-edit">Επεξεργασία</Button>) 
                        }
                        <Button className="but-table-delete" ><Trash/></Button>
                        <Button className="but-table-preview" onClick={() => {setModalShow(true); setDataParse(index[i+11])}}>Προβολή</Button>
                </td>
                </tr>
            </tbody>
        </Table>
