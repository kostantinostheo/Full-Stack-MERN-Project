    ...
    <Row>
      <Col>
       <Card className="cards">
         <Card.Body>
            <Row>
              <h5 className="title-cards">Υποχρεωτικά μέτρα ασφαλείας για τον περιορισμό διασποράς της πανδημίας για όλους τους συμμετεχόντες στη διαδικασία των εξετάσεων.</h5>
            </Row>
            <Row>
